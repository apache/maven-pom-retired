 ...
 */
public class MavenBuilderHelperTest
    extends PlexusTestCase
{
    public void testGetNagEmailAddressWhenTypeIsSetToEmail()
        throws Exception
    {
        MavenBuilderHelper mavenBuilderHelper = (MavenBuilderHelper) lookup( MavenBuilderHelper.ROLE );

        File pom = getTestFile( "src/test/repository/maven-builder-helper-1.xml" );

        mavenBuilderHelper.createProjectFromMetadata( pom.toURL() );
    }
